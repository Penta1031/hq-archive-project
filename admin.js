...
const GOOGLE_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbx2xlvi6RzH83Lmn1aYYuKkB1zwmw9TjjLxe2RYzmVfGRnKRlHKwQOfN1IJoqKsc-52/exec';
...
const CATEGORY_OPTIONS = [
    '콘서트', '해외투어', '페스티벌', '버스킹', '음방', '커버', '쇼케이스', '퇴근길', '뮤비',
    '우얘합', '하루의마무리', '라이브',
    '인스타그램', '릴스', '셀카', '투샷',
    '프롬혚쾌', '혚쾌버블',
